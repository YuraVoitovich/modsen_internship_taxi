package io.voitovich.yura.passengerservice.integration.kafka;
...
public class KafkaIntegrationTest {
    ...
    void consumerRating_correctRequest_ratingConsumedAndConfirmationSent() {
        ...
        await().
                ...
                .untilAsserted(() -> {
                            var passengerProfile = passengerProfilerepository.findById(model.ratedId()).get();
                            assertEquals(BigDecimal.valueOf(4.5), passengerProfile.getRating());
                        }
                );
